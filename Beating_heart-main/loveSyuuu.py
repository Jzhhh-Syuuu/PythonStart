...
def scatter_inside(x, y, beta=0.212):
    """
    随机内部扩散
    :param x: 原x
    :param y: 原y
...
def shrink(x, y, ratio):
    ...
    :return: 新坐标
    """
    force = -1 / (((x - CANVAS_CENTER_X) ** 2 + (y - CANVAS_CENTER_Y) ** 2) ** 0.45)  # 这个参数...
...
class Heart:
    ...
    def calc_position(x, y, ratio):
        # 调整缩放比例
        force = 1 / (((x - CANVAS_CENTER_X) ** 2 + (y - CANVAS_CENTER_Y) ** 2) ** 0.50)  # 魔法参数
